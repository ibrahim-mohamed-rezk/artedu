...
import {
  QuestionsBankFilters as QuestionsBankFiltersType,
  Level,
  Subject,
} from "@/libs/types/tpes";
import { useEffect, useRef, useState } from "react";

const QuestionsBankFilters = ({
  setOpenFilters,
  filters,
  setFilters,
}: {
  setOpenFilters: React.Dispatch<React.SetStateAction<boolean>>;
  filters: QuestionsBankFiltersType;
  setFilters: (filters: QuestionsBankFiltersType) => void;
}) => {
  ...
  const [localFilters, setLocalFilters] =
    useState<QuestionsBankFiltersType>(filters);
