...
import {
  BooksFilters as BooksFiltersType,
  Level,
  Subject,
...
const BooksFilters = ({
  ...
  filters: BooksFiltersType;
  setFilters: (filters: BooksFiltersType) => void;
}) => {
  ...
  const [localFilters, setLocalFilters] = useState<BooksFiltersType>(filters);
