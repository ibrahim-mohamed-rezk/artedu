...
const BankCard = ({
  ...
  return (
    <div className="w-[235px] h-[370px] relative bg-white rounded-[30px] shadow-md border-2 border-[#f1f1f2] overflow-hidden">
      <img
      ...
      <div className="p-4">
        ...
        <h3
          title={courseName}
          className="text-lg line-clamp-1 font-bold text-black font-sst-arabic"
        >
          {courseName}
        </h3>
        <div className="flex justify-start items-center gap-2">
          ...
          {isFreePrice(price) ? (
            <div className="text-right">
              <span className="text-[#26577c] text-base font-bold font-sst-arabic">
                {formatPrice(price)}
              </span>
            </div>
          ) : (
        ...
        <Link 
          href={`/payments/bank/${courseId}`}
          className="block w-full bg-[#e55604] text-white py-2 rounded-[15px] font-medium text-center my-2 hover:bg-[#d14d03] transition-colors"
        >
           شراء
        </Link>
      </div>
