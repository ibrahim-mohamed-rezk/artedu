  ...
  return (
    <div className="w-full">
      <div className="w-full relative">
        ...
        {/* buttons */}
        <div className="absolute top-[30%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-wrap justify-center items-center gap-2 w-full max-w-md">
          <button className="flex items-center gap-2 px-4 py-2 bg-[#e55604] text-white rounded-full">
            <span className="text-center text-lg font-medium font-['SST Arabic']">
              بنك الاسئلة
            </span>
            <svg
              width="24"
          ...
          <button className="px-4 py-2 bg-white text-[#8d8d8d] rounded-full">
            <span className="text-center text-lg font-medium font-['SST Arabic']">
              الكورسات
            </span>
          </button>
