        ...
        <div className="bg-white rounded-3xl w-[534px] flex items-center justify-center flex-col p-8">
          ...
          <div className="flex flex-col items-center gap-14 w-full mt-[30px] ">
            <div className="w-full flex flex-col items-center gap-6">
              ...
              >
                <Link href="/signup" className="flex-1 px-5 py-4  flex justify-center items-center">
                  <span className="text-[#7D7D91] text-xl font-medium font-['SST Arabic']">
                    مستخدم جديد
                  </span>
                </Link>
                <Link href="/login" className="flex-1 px-5 py-4 bg-white rounded-tr-[73.44px] rounded-tl-[8.81px] rounded-br-[73.44px] rounded-bl-[8.81px] shadow-inner border border-gray-100/50 flex justify-center items-center">
