          ...
          <div className="flex flex-col items-center gap-8 md:gap-14 w-full mt-4 md:mt-[30px]">
            <div className="w-full flex flex-col items-center gap-4 md:gap-6">
              ...
              >
                <Link
                  href="/signup"
                  className="flex-1 px-2 md:px-5 py-3 md:py-4 bg-white rounded-tl-[73.44px] rounded-tr-[8.81px] rounded-bl-[73.44px] rounded-br-[8.81px] shadow-inner border border-gray-100/50 flex justify-center items-center"
                >
              ...
              {/* Form Fields */}
              <Signup className="w-full [&_input:focus]:ring-2 [&_input:focus]:ring-[var(--color-primary)] [&_input:focus]:border-[var(--color-primary)] [&_select:focus]:ring-2 [&_select:focus]:ring-[var(--color-primary)] [&_select:focus]:border-[var(--color-primary)]" />
            </div>
          </div>
        </div>
      </div>
